...
extension MKMapView {
    ...
    func setCenter(coordinate: CLLocationCoordinate2D, zoomLevel: Float, animated: Bool) {
    ...
    private func coordinateSpan(centerCoordinate: CLLocationCoordinate2D, zoomLevel: Float) -> MKCoordinateSpan {
        ...
        let zoomScale = Double(pow(Float(2), zoomExponent))
